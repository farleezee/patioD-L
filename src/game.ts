...
imageFromURL12.addComponentOrReplace(transform38)
...
imageFromURL13.addComponentOrReplace(transform39)
...
imageFromURL14.addComponentOrReplace(transform40)
...
imageFromURL15.addComponentOrReplace(transform41)
...
imageFromURL16.addComponentOrReplace(transform42)
...
script1.spawn(imageFromURL12, {"image":"https://i.imgur.com/HlS2FQs.jpg"}, createChannel(channelId, imageFromURL12, channelBus))
script1.spawn(imageFromURL13, {"image":"https://i.imgur.com/i57SYZ5.jpg"}, createChannel(channelId, imageFromURL13, channelBus))
script1.spawn(imageFromURL14, {"image":"https://i.imgur.com/HlS2FQs.jpg"}, createChannel(channelId, imageFromURL14, channelBus))
script1.spawn(imageFromURL15, {"image":"https://i.imgur.com/sgCcz2y.jpg"}, createChannel(channelId, imageFromURL15, channelBus))
script1.spawn(imageFromURL16, {"image":"https://i.imgur.com/HlS2FQs.jpg"}, createChannel(channelId, imageFromURL16, channelBus))
