...
messageBubble.addComponentOrReplace(transform17)
...
messageBubble2.addComponentOrReplace(transform18)
...
nft.addComponentOrReplace(transform19)
...
nft2.addComponentOrReplace(transform20)
...
imageFromURL3.addComponentOrReplace(transform21)
...
wallPlainGlass8.addComponentOrReplace(transform22)

const doorframeNavy2 = new Entity('doorframeNavy2')
engine.addEntity(doorframeNavy2)
doorframeNavy2.setParent(_scene)
const gltfShape5 = new GLTFShape("72f9b185-9fde-469c-8b57-899e5f89b18e/NavyDoorframe.glb")
gltfShape5.withCollisions = true
gltfShape5.isPointerBlocker = true
gltfShape5.visible = true
doorframeNavy2.addComponentOrReplace(gltfShape5)
...
doorframeNavy2.addComponentOrReplace(transform23)
...
wallPlainGlass9.addComponentOrReplace(transform24)
...
wallPlainGlass.addComponentOrReplace(transform25)
...
imageFromURL24.addComponentOrReplace(transform26)
...
const transform27 = new Transform({
  position: new Vector3(0.14277219772338867, 0, 15.782150268554688),
...
wallHexagonGrid9.addComponentOrReplace(gltfShape6)
const transform28 = new Transform({
  position: new Vector3(0.14277124404907227, 5.499999046325684, 15.783172607421875),
  rotation: new Quaternion(7.728269318441928e-15, 1, -1.1920926823449918e-7, 0),
  scale: new Vector3(1.9670467376708984, 1.115785837173462, 0.3672058582305908)
})
wallHexagonGrid9.addComponentOrReplace(transform28)
...
imageFromURL29.addComponentOrReplace(transform33)
...
wallPlainGlass10.addComponentOrReplace(transform34)
...
imageFromURL30.addComponentOrReplace(transform35)
...
imageFromURL31.addComponentOrReplace(transform36)

const wallHexagonGrid12 = new Entity('wallHexagonGrid12')
engine.addEntity(wallHexagonGrid12)
wallHexagonGrid12.setParent(_scene)
wallHexagonGrid12.addComponentOrReplace(gltfShape6)
const transform37 = new Transform({
  position: new Vector3(11.925565719604492, 5.500000476837158, 15.768570899963379),
  rotation: new Quaternion(7.728269318441928e-15, 1, -1.1920926823449918e-7, 0),
  scale: new Vector3(1.967048168182373, 1.115785837173462, 0.36720550060272217)
})
wallHexagonGrid12.addComponentOrReplace(transform37)

const wallHexagonGrid13 = new Entity('wallHexagonGrid13')
engine.addEntity(wallHexagonGrid13)
wallHexagonGrid13.setParent(_scene)
wallHexagonGrid13.addComponentOrReplace(gltfShape6)
const transform38 = new Transform({
  position: new Vector3(11.925566673278809, 4.76837158203125e-7, 15.801494598388672),
  rotation: new Quaternion(7.728269318441928e-15, 1, -1.1920926823449918e-7, 0),
  scale: new Vector3(1.9670476913452148, 1.115785837173462, 0.36720556020736694)
})
wallHexagonGrid13.addComponentOrReplace(transform38)
...
wallPlainGlass11.addComponentOrReplace(transform39)
...
wallPlainGlass12.addComponentOrReplace(transform40)
...
wallPlainGlass2.addComponentOrReplace(transform41)
...
wallHexagonGrid3.addComponentOrReplace(transform42)
...
wallHexagonGrid4.addComponentOrReplace(transform43)
...
imageFromURL13.addComponentOrReplace(transform44)
...
imageFromURL14.addComponentOrReplace(transform45)
...
imageFromURL15.addComponentOrReplace(transform47)
...
imageFromURL16.addComponentOrReplace(transform48)
...
wallPlainGlass5.addComponentOrReplace(transform49)
...
wallPlainGlass6.addComponentOrReplace(transform50)
...
wallHexagonGrid5.addComponentOrReplace(transform51)
...
wallHexagonGrid6.addComponentOrReplace(transform52)
...
wallHexagonGrid7.addComponentOrReplace(transform53)
...
wallHexagonGrid8.addComponentOrReplace(transform54)
...
wallPlainGlass4.addComponentOrReplace(transform55)
...
imageFromURL21.addComponentOrReplace(transform56)
...
imageFromURL22.addComponentOrReplace(transform57)
...
wallPlainGlass7.addComponentOrReplace(transform58)
